...
function M.list_commands()
	...
	vim.ui.select({
		...
		elseif command == "Find components" then
			close_floating_window()
			require("ror.finders.component").find()
		elseif command == "Find configs" then
			close_floating_window()
			require("ror.finders.config").find()
		elseif command == "Find layouts" then
			close_floating_window()
			require("ror.finders.layout").find()
		elseif command == "Find previews" then
			close_floating_window()
			require("ror.finders.preview").find()
